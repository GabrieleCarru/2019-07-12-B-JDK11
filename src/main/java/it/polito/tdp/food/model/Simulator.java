...
public class Simulator {
	...
	private int k = 5; //numero di stazioni disponibili (5 valore default che può essere modificato)
	...
	private void processEvent(Event e) {
		...
		case INIZIO_PREPARAZIONE:
			...
			for(FoodCalories fc : vicini) {
				if(fc.getFood().getPreparazione() == StatoPreparazione.DA_PREPARARE) {
					prossimo = fc;
